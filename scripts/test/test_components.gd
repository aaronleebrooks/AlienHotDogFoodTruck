...
func _on_test_button_pressed() -> void:
	...
	if custom_button_scene:
		...
		print("TestComponents: Custom button instantiated")
...
func _on_test_panel_pressed() -> void:
	...
	if custom_panel_scene:
		...
		print("TestComponents: Custom panel instantiated")
...
func _on_test_dialog_pressed() -> void:
	...
	if modal_dialog_scene:
		...
		print("TestComponents: Modal dialog instantiated")
...
func _on_test_hud_pressed() -> void:
	...
	if hud_scene:
		...
		print("TestComponents: HUD instantiated")
